...
CONF_OLD_FIRMWARE = "old_firmware"  # Boolean flag for old firmware mode
...
DEFAULT_OLD_FIRMWARE = False  # False = modern firmware, True = old firmware (v3.10d and earlier)
